...
def write_health_report(root: Path | None = None) -> None:
    ...
    lines = [
        "# Graph Health Report",
        "",
        # No wall-clock date: this file is a committed artifact and CI asserts it
        # is unchanged after a rebuild. A generation date would make the report a
        # function of the day it ran, failing the check on the next calendar day.
        "Generated by `pipeline/build/graph_health.py` — derived from the graph "
        "build artifacts, not from wall-clock time.",
        "",
        "## Summary",
        "",
        f"| Metric | Value |",
